Feature: Define New Years Day Holiday
  ...
  Background:
    Given I have a PresidentsDay Holiday Object

  Scenario: verify the name
    Then the name will be "Presidents Day"

  Scenario: verify the description
    Then the description will be "Second Monday in February"

  Scenario: verify a valid date in 2020
    When I check "2020-02-17"
    Then it returns true

  Scenario: verify a valid date in 2021
    When I check "2021-02-15"
    Then it returns true

  Scenario: verify a valid date in 2022
    When I check "2022-02-21"
    Then it returns true
